<?php
  ...
  $pdo->exec("CREATE TABLE IF NOT EXISTS `image`(`id` int(10) unsigned NOT NULL AUTO_INCREMENT, `id_membre` int(10) unsigned NOT NULL, `image` text NOT NULL, PRIMARY KEY (`id`), KEY `id_membre` (`id_membre`))");
